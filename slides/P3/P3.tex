...
\begin{frame}
    ...
    \only<+>{
        ...
        \begin{figure}
            \centering
            \includegraphics[width = .58\textwidth]{melody.png}
        \end{figure}
    }
    \only<+>{
        \begin{figure}
            \centering
            \includegraphics[width = .7\textwidth]{poster.png}
        \end{figure}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \node at (6,-3) {\includegraphics[width = 7cm]{esp_gdelt_themes_lines.png}};
    \end{tikzpicture}
\end{frame}
...
\begin{frame}
    ...
    \only<+>{
        ...
        \begin{itemize}
            \item English version of the questionnaire had \alert{165 questions}; the length of the versions after translation varied (e.g., Serbian had 166 questions).
            \item The questions covered:
            \begin{enumerate}
                \item visits to the demo site (if, how, when, what)
                \item attitudes towards the demo site and its perception (accesibility, safety, friendliness, attractivness)
                \item well-being and loneliness
                \item socio-demographic characteristic
                \item health, physical activity, and dietary habits
                \item psychological stress and emotions
            \end{enumerate}
        \end{itemize}
    }
    \only<+>{
    ...
    \only<+>{
        ...
        \begin{tikzpicture}
            ...
            \node [text width = 1cm] at (2,0) {\includegraphics[width = \textwidth]{database.png}};
            \node at (2,-1) {\footnotesize \textsc{DataBase}};
            \node [text width = 1cm] at (4,0) {\includegraphics[width = \textwidth]{cleaning.png}};
            \node at (4,-1) {\footnotesize \textsc{Preprocessing}};
            \node [text width = 1cm] at (6,0) {\includegraphics[width = \textwidth]{spreadsheet.png}};
            \node at (6, -1) {\footnotesize \textsc{Spreadsheet}};
            \node [text width = 1cm] at (8,0) {\includegraphics[width = \textwidth]{analysis.png}};
            \node at (8,-1) {\footnotesize \textsc{Analysis}};
            \draw [->, -stealth, thick] (.7,0) -- (1.3,0);
            \draw [->, -stealth, thick] (2.7,0) -- node [above] {API} (3.3,0);
            \draw [->, -stealth, thick] (4.7,0) -- (5.3,0);
            \draw [->, -stealth, thick] (6.7,0) -- (7.3,0);
        \end{tikzpicture}
    }
    \only<+>{
        \framesubtitle{Actual workflow}
        ...
        \begin{tikzpicture}
            ...
            \draw [->, -stealth, thick] (4.7,0) -- (5.3,0);
            \draw [->, -stealth, thick] (6.7,0) -- (7.3,0);
            \draw [color = heartOrange] (4,0) circle (.8cm);
        \end{tikzpicture}
    }
\end{frame}
