...
\begin{frame}
    ...
    \only<1>{
        ...
        \begin{center}
            \includegraphics[width = .3\textwidth]{gww.jpg}
        \end{center}
    }
    \only<2>{
        \framesubtitle{Current book}
        \begin{center}
            \includegraphics[width = .3\textwidth]{sierpien.png}
        \end{center}
    }
    \only<3>{
        \framesubtitle{Dyskusyjny Klub Filmowy w Iluzjonie}
        \begin{figure}
            \includegraphics[width = .8\textwidth]{dkf.png}
            \caption{
                \textcolor{blue}{
                    \href{https://www.iluzjon.fn.org.pl/cykle/info/1869/klub-filmowy-kowboje-kontra-kosmici-amerykanski-mit-w-kinie-lat-60.html}{Movie Club}
                    }
            }
        \end{figure}
    }
...
\begin{frame}
    ...
    \only<1>{
        \begin{center}
            \includegraphics[width = .4\textwidth]{copy_paste.png}
        \end{center}
    }
    \only<2>{
        \begin{center}
...
\begin{frame}
    \frametitle{LLMs and AI}
    \only<1>{
        \begin{center}
            \includegraphics[width = .8\textwidth]{chatgpt_meme_original.jpg}
        \end{center}
    }
    \only<2>{
        \begin{center}
            \includegraphics[width = .4\textwidth]{chatgpt_meme.jpg}
        \end{center}
    }
    \only<3>{
        \begin{center}
            \includegraphics[width = \textwidth]{wooclap.png}
        \end{center}
    }
...
\begin{frame}
    \frametitle{Traditional Research Methods}
        ...
        \only<+>{
            \begin{figure}
                \includegraphics[scale = .9]{png/radio_naukowe.jpg}
                \caption{from \textcolor{blue}{\href{https://radionaukowe.pl/podcast/medycyna-oparta-na-dowodach-czy-jest-dla-niej-skuteczna-alternatywa-e165/}{Radio Naukowe}}}
            \end{figure}
