...
\begin{frame}
    ...
    \only<2>{
        ...
        \begin{center}
            \includegraphics[width = .5\textwidth]{png/sandman.png}
        \end{center}
    }
    \only<3>{
        \framesubtitle{Current comics book}
        \begin{center}
            \includegraphics[width = .5\textwidth]{png/raport.jpg}
        \end{center}
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{description}[Google Drive:]
...
\begin{frame}
    ...
    \only<1>{
        \begin{itemize}
            \item On \alert{4.11} and \alert{13.01} we will start at \alert{12.00}
            and finish at 15.15.  That is because there is only 13 Fridays this
            semester.
            \item Attendance is advised.
            \item You are allowed to miss up to \alert{2 classes without a formal excuse}.
            \item Additionaly, you are allowed to miss up to \alert{2 classes in case of a formal
            excuse}.
