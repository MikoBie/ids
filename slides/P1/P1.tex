...
\begin{frame}
    ...
    \only<2>{
        ...
        \begin{center}
            \includegraphics[width = .4\textwidth]{sierpien.png}
        \end{center}
    }
    \only<3>{
        \framesubtitle{Dyskusyjny Klub Filmowy w Iluzjonie}
        \begin{center}
            \includegraphics[width = .7\textwidth]{dkf.png}
        \end{center}
    }
\end{frame}
...
\begin{frame}
    ...
    \only<3>{
        \framesubtitle{Effects of using LLMs and AI on teaching and learning}
        \begin{itemize}
            \item I get less emails asking for help with coding.
            \item I spend more time marking assignments.
            \item There is no difference between marks.
        \end{itemize}
    }
