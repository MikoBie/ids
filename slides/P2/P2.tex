...
\begin{frame}
    ...
    \only<+>{
        \begin{figure}
            \centering
            \includegraphics[width = .5\textwidth]{mentimeter_qr_code.png}
        \end{figure}
    }
    %% \only<+>{
    %%     \begin{figure}
...
\begin{frame}
    ...
    \only<+>{
        \begin{table}
            \begin{tabular}{l | c }
                ...
                YouTube & 2.49 bilion users \\
                Whatsapp & 2.0 bilion users \\
                Instagram & 2.0 billion users \\
                TikTok & 1.53 billion users \\
                WeChat & 1.33 billion users \\
                Telgram & 800 milion users\\
                Snapchat & 750 milion users\\
                Twitter & 619 milion users \\
    ...
    \only<+>{
        According to \href{https://www.brandwatch.com/blog/amazing-social-media-statistics-and-facts/}{\textcolor{blue}{brandwatch.com}} and \href{https://www.statista.com/statistics/617136/digital-population-worldwide/?srsltid=AfmBOorJSR-avB6GfF0tH5GRGwqzgOvGdY0BgsBZrRZv4jjB_nRXCaqO}{\textcolor{blue}{Statista}}:
        \begin{itemize}
            \item the Internet has 6.04 billion users
            \item there are 5.66 billion active social media users
            \item the average time spent on social media in 2022 was 147 minutes (142 minutes in 2018)
